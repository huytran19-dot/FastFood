...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      router.push("/tracking/FD-000123")
    }, 2000)
  }
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea id="address" placeholder="Số nhà, tên đường, phường/xã, quận/huyện" required />
                  </div>
                  <div>
                    <Label htmlFor="note">Ghi chú đơn hàng</Label>
                    <Textarea id="note" placeholder="Ghi chú cho người giao hàng (không bắt buộc)" />
                  </div>
                </CardContent>
              </Card>
