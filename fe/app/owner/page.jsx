...
// Mock stats
const stats = [
  { title: "Đơn hàng mới", value: "12", icon: Package, color: "text-primary", bgColor: "bg-primary/10" },
  { title: "Đang chuẩn bị", value: "8", icon: ChefHat, color: "text-warning", bgColor: "bg-warning/10" },
  { title: "Đang giao", value: "15", icon: Plane, color: "text-secondary", bgColor: "bg-secondary/10" },
  { title: "Hoàn thành hôm nay", value: "47", icon: CheckCircle2, color: "text-success", bgColor: "bg-success/10" },
  { title: "Đánh giá trung bình", value: "4.7", icon: Star, color: "text-warning", bgColor: "bg-warning/10" },
]
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button asChild>
            <Link to="/owner/orders">Xem đơn hàng</Link>
          </Button>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="transition-all">
            ...
            <CardContent>
              ...
              <Button className="w-full" asChild>
                <Link to="/owner/menu">Quản lý menu</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="transition-all">
            ...
            <CardContent>
              ...
              <Button className="w-full" asChild>
                <Link to="/owner/drones">Xem drone</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
