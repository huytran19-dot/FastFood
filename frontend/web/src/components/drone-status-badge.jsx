...
/**
 * @typedef {'PENDING'|'CONFIRMED'|'PREPARING'|'READY'|'DELIVERING'|'WAITING_OTP'|'COMPLETED'|'CANCELLED'|'FAILED'} DroneStatus
 */
...
const statusConfig = {
  ...
  READY: { label: "Sẵn sàng giao", className: "bg-secondary text-secondary-foreground" },
